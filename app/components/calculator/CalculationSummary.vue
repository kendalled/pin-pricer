...
const hasInvalidBreakdown = computed(() => {
  ...
  const { basePrice, setupFee, platingCost, backingCost, packagingCost, rushFee, moldFee, total, unitPrice } = props.breakdown;
  
  // Check for invalid numbers
  const values = [basePrice, setupFee, platingCost, backingCost, packagingCost, rushFee, moldFee, total, unitPrice];
